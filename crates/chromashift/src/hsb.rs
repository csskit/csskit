...
/// An colour represented as Hue, Saturation, and Brightness expressed in the sRGB colour space.
/// The components are:
/// - Hue - a number between 0.0 and 360.0
/// - Saturation - a number between 0.0 and 100.0
/// - Lightness - a number between 0.0 and 100.0
...
impl From<Srgb> for Hsb {
	fn from(value: Srgb) -> Self {
		...
		Hsb::new(hue, saturation * 100.0, brightness * 100.0, value.alpha)
	}
}

impl From<Hsb> for Srgb {
