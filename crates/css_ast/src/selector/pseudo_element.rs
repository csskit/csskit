use super::prelude::*;
use crate::{MozPseudoElement, MsPseudoElement, OPseudoElement, WebkitPseudoElement};
...
macro_rules! apply_pseudo_element {
	($macro: ident) => {
		$macro! {
			...
			ClearIcon: CssAtomSet::ClearIcon,
			ColorSwatch: CssAtomSet::ColorSwatch,
			Column: CssAtomSet::Column,
			Cue: CssAtomSet::Cue,
			CueRegion: CssAtomSet::CueRegion,
			DetailsContent: CssAtomSet::DetailsContent,
			FieldComponent: CssAtomSet::FieldComponent,
			FieldSeparator: CssAtomSet::FieldSeparator,
			FieldText: CssAtomSet::FieldText,
			...
			SearchText: CssAtomSet::SearchText,
			SliderFill: CssAtomSet::SliderFill,
			SliderThumb: CssAtomSet::SliderThumb,
			SliderTrack: CssAtomSet::SliderTrack,
			StepControl: CssAtomSet::StepControl,
			StepDown: CssAtomSet::StepDown,
			StepUp: CssAtomSet::StepUp,
