...
/// Represents the style value for `animation-delay-end` as defined in [css-animations-2](https://drafts.csswg.org/css-animations-2/#animation-delay-end).
///
/// The grammar is defined as:
///
/// ```text,ignore
...
#[cfg_attr(feature = "serde", derive(serde::Serialize), serde())]
#[cfg_attr(feature = "css_feature_data", derive(ToCSSFeature), css_feature("css.properties.animation-delay-end"))]
#[cfg_attr(feature = "visitable", derive(Visitable), visit)]
#[derive(csskit_derives::NodeWithMetadata)]
pub struct AnimationDelayEndStyleValue<'a>;

/// Represents the style value for `animation-delay-start` as defined in [css-animations-2](https://drafts.csswg.org/css-animations-2/#animation-delay-start).
///
/// The grammar is defined as:
///
/// ```text,ignore
...
/// ```
///
/// https://drafts.csswg.org/css-animations-2/#animation-delay-start
#[syntax(" <time># ")]
#[derive(
	Parse, Peek, ToSpan, ToCursors, DeclarationMetadata, SemanticEq, Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash,
)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize), serde())]
#[cfg_attr(feature = "css_feature_data", derive(ToCSSFeature), css_feature("css.properties.animation-delay-start"))]
#[cfg_attr(feature = "visitable", derive(Visitable), visit)]
#[derive(csskit_derives::NodeWithMetadata)]
pub struct AnimationDelayStartStyleValue<'a>;
