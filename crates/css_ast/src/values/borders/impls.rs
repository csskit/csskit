...
mod tests {
	...
	pub fn size_test() {
		...
		assert_eq!(std::mem::size_of::<CornerTopLeftStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerTopRightStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerBottomLeftStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerBottomRightStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerStartStartStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerStartEndStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerEndStartStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<CornerEndEndStyleValue>(), 104);
