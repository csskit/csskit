...
mod tests {
	...
	#[test]
	pub fn size_test() {
		assert_eq!(std::mem::size_of::<BorderTopColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderRightColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderBottomColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderLeftColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderBlockStartColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderBlockEndColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderInlineStartColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderInlineEndColorStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<BorderColorStyleValue>(), 216);
		assert_eq!(std::mem::size_of::<BorderBlockColorStyleValue>(), 104);
		assert_eq!(std::mem::size_of::<BorderInlineColorStyleValue>(), 104);
