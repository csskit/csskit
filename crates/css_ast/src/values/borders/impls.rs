...
mod tests {
	...
	pub fn size_test() {
		...
		assert_eq!(std::mem::size_of::<BorderTopLeftRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderTopRightRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderBottomRightRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderBottomLeftRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderStartStartRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderStartEndRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderEndStartRadiusStyleValue>(), 64);
		assert_eq!(std::mem::size_of::<BorderEndEndRadiusStyleValue>(), 64);
		...
		assert_eq!(std::mem::size_of::<CornerShapeStyleValue>(), 192);
		assert_eq!(std::mem::size_of::<CornerTopLeftShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerTopRightShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerBottomRightShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerBottomLeftShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerStartStartShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerStartEndShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerEndStartShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerEndEndShapeStyleValue>(), 48);
		assert_eq!(std::mem::size_of::<CornerTopShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerRightShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerBottomShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerLeftShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerBlockStartShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerBlockEndShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerInlineStartShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerInlineEndShapeStyleValue>(), 96);
		assert_eq!(std::mem::size_of::<CornerTopLeftStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerTopRightStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerBottomLeftStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerBottomRightStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerStartStartStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerStartEndStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerEndStartStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerEndEndStyleValue>(), 112);
		assert_eq!(std::mem::size_of::<CornerTopStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerLeftStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerRightStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerBottomStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerBlockStartStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerBlockEndStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerInlineStartStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerInlineEndStyleValue>(), 208);
		assert_eq!(std::mem::size_of::<CornerStyleValue>(), 400);
