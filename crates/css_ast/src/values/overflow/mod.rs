...
// TODO: The spec grammar is `none | [ [ before | after ] || [ links | tabs ] ]` but the `||`
// combinator is not yet supported by the syntax proc macro. Using simplified grammar for now.
