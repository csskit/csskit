...
#[declaration_metadata(
    ...
    percentages = Unknown,
    longhands = AnimationRangeStart|AnimationRangeEnd,
    reset_by = Animation,
...
#[declaration_metadata(
    ...
    applies_to = Elements,
    percentages = Unknown,
    longhands = ScrollTimelineName|ScrollTimelineAxis,
    property_group = ScrollAnimations,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
)]
...
#[declaration_metadata(
    ...
    animation_type = Unknown,
    percentages = Unknown,
    longhands = ViewTimelineName|ViewTimelineAxis|ViewTimelineInset,
    property_group = ScrollAnimations,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
)]
