...
#[declaration_metadata(
    ...
    longhands = ScrollMarginTop|ScrollMarginRight|ScrollMarginBottom|ScrollMarginLeft,
    property_group = ScrollSnap,
...
#[declaration_metadata(
    ...
    applies_to = Elements,
    animation_type = ByComputedValue,
    longhands = ScrollMarginBlockStart|ScrollMarginBlockEnd,
    property_group = ScrollSnap,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
...
#[declaration_metadata(
    ...
    applies_to = Elements,
    animation_type = ByComputedValue,
    longhands = ScrollMarginInlineStart|ScrollMarginInlineEnd,
    property_group = ScrollSnap,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
...
#[declaration_metadata(
    ...
    longhands = ScrollPaddingLeft|ScrollPaddingRight|ScrollPaddingTop|ScrollPaddingBottom,
    property_group = ScrollSnap,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
)]
...
#[declaration_metadata(
    ...
    animation_type = ByComputedValue,
    percentages = Scrollport,
    longhands = ScrollPaddingBlockStart|ScrollPaddingBlockEnd,
    property_group = ScrollSnap,
    computed_value_type = Unknown,
    canonical_order = "per grammar",
    box_side = BlockStart|BlockEnd,
