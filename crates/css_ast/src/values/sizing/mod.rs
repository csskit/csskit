...
/// Represents the style value for `column-width` as defined in [css-sizing-4](https://drafts.csswg.org/css-sizing-4/#column-width).
///
...
/// ```
///
/// https://drafts.csswg.org/css-sizing-4/#column-width
#[syntax(" auto | <box-size> ")]
#[derive(
	Parse, Peek, ToSpan, ToCursors, DeclarationMetadata, SemanticEq, Debug, Clone, PartialEq, Eq, PartialOrd, Ord, Hash,
)]
